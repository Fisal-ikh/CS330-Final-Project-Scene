...
void SceneManager::DefineObjectMaterials()
{
	...
	glassMaterial.ambientColor = glm::vec3(0.6f, 0.6f, 0.6f);
...
void SceneManager::SetupSceneLights()
{
	...
	//posiiton of the light source
	m_pShaderManager->setVec3Value("lightSources[0].positon", 3.0f, 5.0f, 4.0f);
	//set the ambient emission color
	m_pShaderManager->setVec3Value("lightSources[0].ambientColor", 0.4f, 0.0f, 0.4f);
	//defines the difuse light emission color
	m_pShaderManager->setVec3Value("lightSources[0].diffuseColor", 0.6f, 0.0f, 0.0f);
	//defines the light reflection color
	m_pShaderManager->setVec3Value("lightSources[0].specularColor", 0.6f, 0.4f, 0.4f);
	//defines light strength
	m_pShaderManager->setFloatValue("lightSources[0].focalStrength", 40.0f);
	//defines intesnity of light
	m_pShaderManager->setFloatValue("lightSources[0].specularIntensity", 0.9f);

	//posiiton of the light source
	m_pShaderManager->setVec3Value("lightSources[1].positon", 0.0f, 0.0f, 0.0f);
	//set the ambient emission color
	m_pShaderManager->setVec3Value("lightSources[1].ambientColor", 0.6f, 0.0f, 0.6f);
	//defines the difuse light emission color
	m_pShaderManager->setVec3Value("lightSources[1].diffuseColor", 0.5f, 0.0f, 0.0f);
	//defines the light reflection color
...
/**************************************************************/
/*** STUDENTS CA`N MODIFY the code in the methods BELOW for  ***/
...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture("../../Utilities/textures/stainless_end.jpg", "stainless_end");
	...
	bReturn = CreateGLTexture("Textures/mouse.png", "mouse");
	bReturn = CreateGLTexture("Textures/keyboard.jpg", "keyboard");
	bReturn = CreateGLTexture("Textures/paper.jpg", "notebook");
...
void SceneManager::RenderScene()
{
	...
	scaleXYZ = glm::vec3(1.3f, 1.0f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(1.0f, 4.0f, 4.0f);
	...
	SetShaderColor(2, 2, 2, 2);
	SetShaderMaterial("clay");
	SetShaderTexture("notebook");
	// draw the mesh with transformation values
	m_basicMeshes->DrawPlaneMesh();

	scaleXYZ = glm::vec3(1.9f, 1.0f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-3.0f, 5.0f, 4.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-0.2f, 6.5f, 4.0f);
...
void SceneManager::BackDrop()
{
	...
	// set the XYZ posi3tion for the mesh
...
void SceneManager::PenBody()
{
	// Pen body (cylinder)
	glm::vec3 scaleXYZ = glm::vec3(0.2f, 1.5f, 0.2f);
	float XrotationDegrees = 0.0f;
	float YrotationDegrees = 0.0f;
	float ZrotationDegrees = 0.0f;
	glm::vec3 positionXYZ = glm::vec3(3.0f, 2.0f, 4.0f);
	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
	SetShaderColor(1.0f, 0.0f, 0.0f, 1.0f); //red
	//sets the texture
...
void SceneManager::PenCap()
{
	// Pen cap (cylinder)
	glm::vec3 scaleXYZ = glm::vec3(0.2f, 0.8f, 0.2f);
	float XrotationDegrees = 0.0f;
	float YrotationDegrees = 0.0f;
	float ZrotationDegrees = -30.0f;
	glm::vec3 positionXYZ = glm::vec3(4.2f, 2.8f, 3.8f);
	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
	SetShaderColor(0.0f, 0.0f, 2.0f, 1.0f); //blue
	SetShaderTexture("ball");
	SetShaderMaterial("glass");

	m_basicMeshes->DrawCylinderMesh();
}
void SceneManager::PenCapExt()
{
	// Pen cap extention(plane)
	glm::vec3 scaleXYZ = glm::vec3(0.4f, 0.4f, 0.1f);
	float XrotationDegrees = 90.0f;
	float YrotationDegrees = 60.0f;
	float ZrotationDegrees = 0.0f;
	glm::vec3 positionXYZ = glm::vec3(4.2f, 2.7f, 4.0f);
	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
	SetShaderColor(0.0f, 1.0f, 1.0f, 1.0f); //teal
	SetShaderTexture("gold");
...
void SceneManager::PenTip()
{
	...
	float YrotationDegrees = 0.0f;
	float ZrotationDegrees = 0.0f;
	glm::vec3 positionXYZ = glm::vec3(3.0f, 3.5f, 4.0f);
	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
	SetShaderColor(0.0f, 1.0f, 0.0f, 1.0f); //green
